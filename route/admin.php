...
Route::group(config('admin.api_admin_prefix') . '/', function () {
    ...
    Route::group(function () {
        ...
        Route::group('merchant/intention', function () {
            ...
            Route::get('allintention', '/allintention');
        ...
        Route::group('user', function () {
            ...
            Route::get('promoter/lstleve/:id', '/getOneLevelList')->name('systemgetOneLevelList');
            Route::get('update/form/:id', '/updateForm')->name('systemUserUpdateForm');
            Route::post('update/:id', '/update')->name('systemUserUpdate');
            Route::post('changePs/form/:id', '/changePsForm')->name('systemUserChangePsForm');
            Route::post('changePs/:id', '/changePs')->name('systemUserChangePs');
            // Route::get('lst', '/lst')->name('systemUserLst');
            //修改用户分组
            ...
            // 修改用户密码
            Route::get('change_pwd/form/:id', '/changePwdForm')->name('systemUserChangePwdForm');
            Route::post('change_pwd/:id', '/changePwd')->name('systemUserChangePwd');

            //删除用户
            Route::post('delUser/:id', '/delUser');
            ...
            // 修改用户贡献值
            Route::get('change_now_gongxian/form/:id', '/changeNowGongxianForm')->name('systemUserChangeNowGongxianForm');
            Route::post('change_now_gongxian/:id', '/changeNowGongxian')->name('systemUserChangeNowGongxian');
            // 修改用户兑换值
            Route::get('change_now_duihuan/form/:id', '/changeNowDuihuanForm')->name('systemUserChangeNowDuihuanForm');
            Route::post('change_now_duihuan/:id', '/changeNowDuihuan')->name('systemUserChangeNowDuihuan');
            // 修改用户数全值
            Route::get('change_now_shuquan/form/:id', '/changeNowShuquanForm')->name('systemUserChangeNowShuquanForm');
            Route::post('change_now_shuquan/:id', '/changeNowShuquan')->name('systemUserChangeNowShuquan');
            // 修改用户股权值
            Route::get('change_now_price/form/:id', '/changeNowPriceForm')->name('systemUserChangeNowPriceForm');
            Route::post('change_now_price/:id', '/changeNowPrice')->name('systemUserChangeNowPrice');
            // 用户提现审核
            Route::get('cash_user_verify/form/:id', '/cashUserVerifyForm')->name('systemUserCashUserVerifyForm');
            Route::post('cash_user_verify/:id', '/cashUserVerify')->name('systemUserCashUserVerify');
            //微信图文群发
            ...
            Route::get('cash_user_verify_bk/:id', '/cash_user_verify_bk');
        ...
        Route::group('user/extract', function () {
            ...
            Route::get('merlst', 'MerExtract/lst')->name('systemUserExtractLst');
            Route::post('merstatus/:id', 'MerExtract/switchStatus')->name('systemUserExtractSwitchStatus');

            Route::get('export', 'UserExtract/export') ;
            Route::get('export2', 'UserExtract/export2') ;
        ...
        Route::group('bill', function () {
            ...
            Route::get('syscapitallist', 'UserBill/getsyscapitalList') ;

            Route::get('scanlist', 'UserBill/getScanlist') ;



            Route::get('subinfolist', 'UserBill/subinfolist') ;
            Route::get('subinfoexport', 'UserBill/subinfoexport') ;
            Route::post('subinfostatus/:id', 'UserBill/subinfostatus')->name('subinfoStatus') ;
            Route::get('subinfoform/:id', 'UserBill/subinfoform') ;


            Route::get('mercoinlist', 'UserBill/getmercoinlist') ;

            Route::get('usersign', 'UserBill/usersign') ;
...
//        })->prefix('admin.store.StoreService');
        ...
        Route::group('statistics', function () {
            ...
            //快速计算
            Route::get('ckcmpu', '/ckcmpu');
            Route::get('ckcmpu2', '/ckcmpu2');


            Route::get('main2', '/main2');
        ...
        Route::group('order', function () {
            ...
            Route::get('orderrefund/:id', 'Order/orderrefund');
...
//不带token认证
    Route::group(function () {
        ...
        Route::get('updatepwd', 'admin.system.admin.Login/updatepwd');
