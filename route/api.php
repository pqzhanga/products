...
Route::group('api/', function () {
    //
    //Route::rule('notice/testf', 'api.Common/testf');
    //强制登录
    Route::group(function () {
        ...
        Route::post('cardInfoUpdate', 'api.Auth/cardInfoUpdate');


        Route::post('auth/verify2', 'api.Auth/verify2');

        Route::post('auth/change_pwd2', 'api.Auth/changePassword2');
        ...
        //注销账户
        Route::post('releaseUser', 'api.Auth/releaseUser');
        ...
        Route::group('order', function () {
            ...
            Route::post('orderinsertTelephoneFareOrder', '/insertTelephoneFareOrder');//创建话费充值订单
            Route::post('temporderinsertTelephoneFareOrder', '/tempinsertTelephoneFareOrder');//临时创建话费充值订单h5
            Route::get('orderselectTelephoneFareOrder', '/selectTelephoneFareOrder');//查询充值订单
            Route::post('paychannel', '/paychannel');
        ...
        Route::group('user', function () {
            ...
            //话费充值
            Route::post('/insertTelephoneFareOrder', 'UserRecharge/insertTelephoneFareOrder');//创建充值订单
            Route::post('/placeTelephoneFareOrder', 'UserRecharge/placeTelephoneFareOrder');//发起充值支付
            Route::post('/selectTelephoneFareOrder', 'UserRecharge/selectTelephoneFareOrder');//查询充值订单
            Route::post('/getTelProduct', 'UserRecharge/getTelProduct');//获取产品
            //地址
            ...
            //地址2
            Route::get('/address2/lst', 'UserAddress2/lst');
            Route::post('/address2/create', 'UserAddress2/create');
            Route::get('/address2/detail/:id', 'UserAddress2/detail');
            Route::post('/address2/update/:id', 'UserAddress2/editDefault');
            Route::post('/address2/delete/:id', 'UserAddress2/delete');


            //分销海报
            Route::get('/spread_image', 'User/spread_image');
            Route::get('/v2/spread_image', 'User/spread_image_v2');
            Route::get('/v3/spread_image', 'User/spread_image_v3');
            //推广人列表
            Route::get('/spread_list', 'User/spread_list');
            Route::get('/spread_list2', 'User/spread_list2');
            ...
            //商户提现
            Route::get('/merextract/lst', 'MerExtract/lst');
            Route::get('/merextract/banklst', 'MerExtract/bankLst');
            Route::post('/merextract/create', 'MerExtract/create');
            ...
            Route::get('scanbill', 'User/scanbill');
            //佣金记录
            Route::get('brokerage_list', 'User/brokerage_list');
            Route::get('brokerage_shuquan_list', 'User/brokerage_shuquan_list');
            Route::get('brokerage_duihuan_list', 'User/brokerage_duihuan_list');
            Route::get('brokerage_gongxian_list', 'User/brokerage_gongxian_list');
            //推广人订单
            ...
            Route::get('signlist2','User/signinlist2');
            Route::get('reg_sub','User/reg_sub');
            Route::get('reg_sub_list','User/reg_sub_list');
            Route::get('goods_add_list','User/goods_add_list');
            Route::post('goods_add','User/goods_add');
            Route::post('goods_list','User/goods_list');
            Route::post('switch_status','User/switch_status');
            Route::post('goods_edit','User/goods_edit');
            Route::post('msg_log','User/msg_log');

            //浏览记录
            Route::get('history', 'User/history');
            Route::post('history/delete/:id', 'User/deleteHistory');
            Route::post('history/batch/delete', 'User/deleteHistoryBatch');
        ...
        //获取扫码支付信息
        Route::post('common/pay_info', 'api.Common/payInfo');
        Route::post('common/sc_info', 'api.Common/sc_info');
    ...
    Route::group(function () {
        ...
        Route::group('store/product', function () {
            ...
            Route::get('seckill/detail/:id', 'StoreProductSeckill/detail')->middleware(VisitProductMiddleware::class);;
            ...
            Route::get('/presell/detail/:id', 'StoreProductPresell/detail');
            //预售协议
            ...
            Route::get('group/detail/:id','StoreProductGroup/detail');
        ...
        Route::group('admin', function () {
            ...
            Route::get('/scan_order_list', '/scanOrderList');
            Route::get('/mer_order_list', '/merOrderList');
            Route::get('/regquery', '/regquery');
            ...
            /////n1 让利比例
            Route::post('/crate', '/crate');
            Route::post('/setSoundCode', '/setSoundCode');//设置语音播报
            Route::get('/getSoundCode', '/getSoundCode');//获取语音播报数据
        ...
        //test
        Route::get('store/test', 'api.Auth/test');
    ...
    //快付支付回调
    Route::any('notice/fastpay_pay', 'api.Common/fastpayNotify')->name('fastpayNotify');
    //话费充值回调接口
    Route::any('notice/telephoneFareOrderNotify', 'api.Common/telephoneFareOrderNotify')->name('telephoneFareOrderNotify');
    //测试用
    Route::any('common/test', 'api.Common/testfone');
    //临时
    Route::any('common/tempplaceTelephoneFareOrder', 'api.Common/tempplaceTelephoneFareOrder');
    //临时快付分账
    Route::any('common/tempKFfenzhang', 'api.Common/tempKFfenzhang');
    //临时话费查询
    Route::any('common/tempchongzhilist', 'api.Common/tempchongzhilist');

    Route::post('common/checkupdate', 'api.Common/checkupdate');
