...
//            $data['mer_address']  = $data['province'].$data['city'].$data['district'].' '.$data['mer_address'];
    ...
    {
        $data = $this->request->params([['category_id', 0], 'mer_name',  'sub_name', 'sub_mer' , 'crate' , 'commission_rate', 'real_name', 'mer_phone', 'mer_keyword', 'mer_address', 'mark', ['sort', 0], ['status', 0], ['is_audit', 0], ['is_best', 0], ['is_bro_goods', 0], ['is_bro_room', 0], ['is_trader', 0],'district_id']);
        if (!$isUpdate)
